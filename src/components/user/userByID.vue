    ...
    <div class="profile-tile">
      ...
      <div class="profile-tile-meta">
        <ul>
          ...
          <li>Sponsor:<strong>{{ user.genealogies.sponsor.name }}</strong> ({{ user.genealogies.sponsor.username }})</li>
      ...
      <div class="col-sm-6">
        <div class="element-wrapper">
          ...
          <div class="element-box-tp">
            <div class="activity-boxes-w" v-for="graduation in user.graduations">
              <div class="activity-box-w">
                ...
                <div class="activity-box">
                  ...
                  <div class="activity-info">
                    ...
                    <strong class="activity-title">Initial Score: {{ graduation.dots_start }}</strong>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  created () {
    this.$http.get('genealogy/show').then( response => {
